...
if(NpcHandler == nil) then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_MISSINGMONEY]	= 'Desculpe, voce nao possui dinheiro suficiente.',
			[MESSAGE_NEEDMONEY] 	= 'Desculpe, voce nao possui dinheiro suficiente.',
			[MESSAGE_MISSINGITEM] 	= 'Voce nao possui esse item, |PLAYERNAME|!',
			[MESSAGE_NEEDITEM]	= 'Voce nao possui esse item.',
			[MESSAGE_NEEDSPACE]	= 'Voce nao pode carregar esse item.',
			[MESSAGE_NEEDMORESPACE]	= 'Voce nao pode carregar todos esses itens.',
			[MESSAGE_IDLETIMEOUT] 	= 'Proximo, por favor!',
			[MESSAGE_WALKAWAY] 	= 'Que rude!',
			[MESSAGE_DECLINE]	= 'Nao e bom o suficiente... ?',
			[MESSAGE_SENDTRADE]	= 'Essa e minha oferta, |PLAYERNAME|. O que acha?',
			[MESSAGE_NOSHOP]	= 'Desculpe, nao estou oferecendo nada.',
			[MESSAGE_ONCLOSESHOP]	= 'Obrigado, volte quando quiser.',
			[MESSAGE_ALREADYFOCUSED]= '|PLAYERNAME|! Eu ja estou falando com voce...',
			[MESSAGE_PLACEDINQUEUE] = '|PLAYERNAME|, por favor espere pela sua vez. Existem |QUEUESIZE| clientes antes de voce.'
		}
	}
