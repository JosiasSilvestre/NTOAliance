...
npcHandler:say("Certo, ja lhe digo que tens que ter 4 amigos para fazer a quest juntamente com voce quer ir ao local onde fica o {inicio} da quest?.", cid)
talkState[talkUser] = 1
elseif isInArray({"yes","inicio"}, msg) and talkState[talkUser] == 1 then
if getPlayerStorageValue(cid, storage) <= 0 then
npcHandler:say("Boa sorte na quest, voce e mais 3 tem que ficar em cima dos pisos vermelhos e um de voces puxar a alavanca!", cid)
