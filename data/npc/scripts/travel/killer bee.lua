...
local storage,pos = 130,{x=653, y=1521, z=8}
if isInArray({"teleportar","teleport","teleporte","entrar"}, msg) then
...
elseif msg == "no" then  
selfSay("Sabia que era um fracote! Bakayaro! Konoyaro!", cid)  
talkState[talkUser] = 0  
