...
selfSay('Obrigado! Como recompensa pegue e leia esse livro, e de un clan antigo, podera aprender muito com ele...{voce leu o livro}... (Voce recebeu 1000 pontos de experiencia)', cid)
else
selfSay('Exato, saia de konoha e va caminhando para oeste encontrara na entrada da floresta perdida duas rochas, depois siga o caminho e ira me achar la, vou te ensinar a ler o pergaminho.', cid)
end
end
return true
end
