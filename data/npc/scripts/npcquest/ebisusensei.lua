...
selfSay('Sim, se voce terminar as missoes para ele, creio que ele te dara 3 {medalhas} de rank A podendo assim fazer o exame jounin.', cid)
...
selfSay('Muito bem entao, voce ja pode fazer o exame jounin quando quiser, se realmente for um chunin!', cid)
else
selfSay('Nao me faça perder tempo amigo, volte com 3 comprovantes de que completaste 3 missoes rank A para fazer o exame jounin!', cid)
end
end
return true
end
