...
selfSay('Tudo bem entao, sem mais delongas me de o {certificado} da conclusao do exame, pois ficara no seus arquivos ninja que voce concluiu o exame chunin!', cid)
talkState[talkUser] = 1
elseif(msgcontains(msg, 'certificado') and talkState[talkUser] == 1) then
if (getPlayerStorageValue(cid,89745) > 1) then
selfSay('Voce ja fez o exame chunin.', cid)
else
...
selfSay('Cade o certificado Shinobi, sem ele nao podes ganhar o Titulo de Chunin, me traga o CERTIFICADO!', cid)
end
end
return true
end
