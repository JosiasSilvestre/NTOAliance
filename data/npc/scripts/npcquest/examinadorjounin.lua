...
selfSay('Entao ira fazer o {exame} jounin? Este exame nao e nada facil shinobi.', cid)
end
---------------------------------------------------------
if(msgcontains(msg, 'exame')) then
selfSay('Tudo bem entao, para {confirmar}, vou pegar todas medalhas que voce possue que provam que voce fez essas missoes!', cid)
