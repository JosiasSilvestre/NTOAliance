...
selfSay('Descupe, voce nao possui o dinheiro necessario para promover este jogador.', cid)
end
else
...
selfSay('O sistema funciona da seguinte maneira: voce pode colocar recompensas pela cabeça de jogadores, assim, quem matar estes jogadores ira ganhar algum item, porem, ha um alto custo para utilizar os meus servicos.', cid)
talkState[talkUser] = 0
end
