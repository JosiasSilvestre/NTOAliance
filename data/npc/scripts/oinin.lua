...
doBroadcastMessage("Noticia: Jornal Shinobi informa: O shinobi "..msg.." esta procurado, e agora o seu nivel de recompensa e procura é "..getPlayerStorageValue(getPlayerByNameWildcard(msg), 13131)..".", BroadCast_Type)
else
selfSay('Descupe, voce nao possui o dinheiro necessario para por uma recompensa a cabeça a este jogador.', cid)
end
else
...
selfSay('O sistema funciona da seguinte maneira: voce pode colocar recompensas pela cabeça de jogadores, assim, quem matar estes jogadores ira ganhar um bom dinheiro, porem, ha um alto custo para utilizar os meus servicos.', cid)
talkState[talkUser] = 0
end
