local tps = {
        ["Sargento Anbu"] = {pos = {x=1030, y=816, z=6}, toPos = {x=1030, y=816, z=5}, time = 50},
}
...
function onDeath(cid)
                        ...
                        doCreatureSay(cid, "Parabens, pode prosseguir, O teleport ira sumir em "..tp.time.." segundos.", TALKTYPE_ORANGE_1)
