...
local storage = tostring(getPlayerStorageValue(cid, 140001))
...
local storage = getPlayerStorageValue(cid, 140001) == -1 and "" or tostring(getPlayerStorageValue(cid, 140001))
local spellname = '"' .. spellname .. '"'
...
setPlayerStorageValue(cid, 140001, gsub)
else
setPlayerStorageValue(cid, 140001, storage .. spellname .. " " .. tostring(seconds + os.time()) .. " ")
end
